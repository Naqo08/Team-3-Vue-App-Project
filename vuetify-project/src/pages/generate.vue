        ...
        <v-row class="gx-8 gy-8">
          ...
          <v-col cols="12" md="6">
            ...
            >
              ...
              <v-card-title class="text-h5 font-weight-medium text-brown-darken-2 pa-8 pb-0">
              ...
              <v-card-text class="pa-8 pt-4 flex-grow-1 d-flex flex-column">
                ...
                <div class="flex-grow-1 d-flex flex-column">
                  ...
                  <!-- Image Preview -->
                  <v-card v-else border class="uploaded-image-card pa-4 mb-4 flex-grow-1" rounded>
                    <v-img
                      v-if="imagePreview"
                      class="mb-4 rounded"
                      cover
          ...
          <v-col cols="12" md="6">
            ...
            >
              <!-- Header with consistent padding -->
              <div class="text-h5 font-weight-medium text-brown-darken-2 pa-8 pb-0">
                Configuration
              </div>
              <!-- Content area that grows -->
              <v-card-text class="pa-8 pt-4 flex-grow-1 d-flex flex-column">
                <!-- Room Type -->
                <div class="mb-8">
                  <div class="text-h6 font-weight-medium mb-4 text-brown-darken-2">
                    Room Type
                  </div>
                  <v-select
                    v-model="roomType"
